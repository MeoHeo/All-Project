...
#     0 1 2 3 4 5 6 7
# ======================================================================
def play(student_A: object, student_B: object, start_state: object = Initial_Board) -> object:
    ...
    B = Bplayer.Player('b')
    # ========================test===============
    # l= B.findListJump(Initial_Board, 3, 3, 1)
    # l = A.findListAll(Initial_Board)
    # print(l);
    # ========================end-test===========
    currPlayer = A
    state = start_state
