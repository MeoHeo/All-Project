			...
			<div class="content col-sm-10">
				<?php 
					...
					if (isset($_POST['insert'])) {
						...
						$sql = "INSERT INTO phimle(Phimle_id, Tenphim, Quocgia, Thongtinphim, Ngaycapnhat, Theloai, Namphathanh,Ngonngu,Image,Link) VALUES (Phimle_id,'$insert_tenphim','$insert_quocgia','$insert_thongtinphim','2016-11-30','$insert_theloai','$insert_namphathanh','$insert_ngonngu','$insert_image','$insert_linkphim')";
						if ($conn->query($sql)) {
							echo "<script>window.open('filmle.php','_self')</script>";
						}
					}
				?>
				<form style="width: 60%;margin-left: auto;margin-right: auto;" class="form-horizontal" method="post" action="insertfilmle.php" enctype="multipart/form-data">
