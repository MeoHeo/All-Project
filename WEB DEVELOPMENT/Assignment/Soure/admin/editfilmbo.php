			...
			<div class="content col-sm-10">
				<?php 
					...
					if (isset($_GET['edit'])) {
						...
						$sql = "SELECT * FROM phimbo WHERE phimbo_id = $edit_id"; 
				...
				?>
				<div class="col-sm-6">
					<form style="width: 100%;margin-left: auto;margin-right: auto;padding-top: 10px" class="form-horizontal" method="post" action="editfilmbo.php?edit_form=<?php echo $edit_id; ?>" enctype="multipart/form-data">
...
<?php 
	if (isset($_POST['update'])) {
		...
		$sql = "UPDATE phimbo SET Tenphim = '$update_tenphim', Quocgia = $update_quocgia, Thongtinphim = '$update_thongtinphim',Theloai=$update_theloai,Namphathanh=$update_namphathanh,Ngonngu=$update_ngonngu WHERE Phimbo_id = '$update_id'";
		include './connectdatabase.php';
		if ($conn->query($sql)) {
