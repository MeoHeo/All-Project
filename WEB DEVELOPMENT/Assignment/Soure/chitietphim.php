        ...
        <div class="row">
            <div class="col-lg-8">
                <section class="phim-moi-nhat" style="padding-left:30px;">
                    <div class="title">
                        <h3 style="display: inline-block;color: red">THÔNG TIN PHIM</h3>
                    </div>
                    <div class="row chi-tiet-phim">
                            <div class="image col-sm-6">
                                <img src="./libraries/posterfilms<?php echo $row['Image'];?>" width="100%" height="100%">
                            </div>
                            <div class="decsription-chi-tiet-phim col-sm-6">
                                ...
                                <a href="./xemphim.php?phimid=<?php echo $phim_id;?>"><button class="btn btn-success" type="button">Xem phim</button></a>
                                <button class="btn btn-danger" type="button">Xem trailer</button>
                            </div>
                        </div>
                </section>
                <section style="padding-left:30px;margin-top: 20px">
                    <div class="row mo-ta-phim">
                        <div class="title">
                            Mô tả phim
                        </div>
